...
export const es: Translations = {
  ...
  lucia: {
    title: 'LucIA',
    intro: 'Soy LucIA. Cuéntame qué problema quieres resolver con IA.',
    placeholder: 'Háblale a LucIA…',
    prefillMvp: 'Hola LucIA, me interesa el paquete MVP para startups.',
    openLabel: 'Hablar con LucIA',
    send: 'Enviar',
    error: 'Se me cruzaron los cables. Inténtalo de nuevo en un momento.',
  },
  footer: {
